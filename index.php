...
//header("Access-Control-Allow-Origin: self *.jquery.com cdn.jsdelivr.net");
header("Access-Control-Allow-Origin: *");
//header("Access-Control-Allow-Methods: POST, GET, OPTIONS, SCRIPT");
...
//Error::pdump($_SERVER, '$_SERVER');
//Error::pdump(__DIR__);
//Error::pdump(password_hash("123", PASSWORD_BCRYPT));
...
/*            if (!isset($_REQUEST['id'])) {
                ...
                $Rep = new \OnlineRecord\Report(filter_var($_REQUEST['id'], FILTER_SANITIZE_NUMBER_INT));
                $lk->addContent($Rep->getReport());
            }*/
            break;
        ...
        case 'download':
            //Error::pdump('Качаем');
            //Error::pdump($_REQUEST['file'],'$_REQUEST["file"]');
        ...
        case 'printpoz':
                ...
                //$dc = new \OnlineRecord\DocCreator(filter_var($_REQUEST['doctype'], FILTER_SANITIZE_NUMBER_INT), $student);
            break;
        ...
        case 'searchuser':
            //$lk->addContent('группа='.($_REQUEST['group'] ?? null));
